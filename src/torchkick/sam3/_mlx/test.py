...
from torchkick.sam3._mlx.model import build_sam3_image_model
from torchkick.sam3._mlx.backbone.processor import Sam3Processor
...
def main():
    ...
    model = build_sam3_image_model(
        bpe_path="sam3/_mlx/assets/bpe.txt.gz",
    ...
    inference_state = processor.set_text_prompt(state=inference_state, prompt="player in white")
